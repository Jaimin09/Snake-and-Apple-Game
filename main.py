...
slitherbackground2= pygame.image.load('Images/slitherbackground2.png')
slitherimp= pygame.image.load('Images/slitherimp.png')
title_edited = pygame.image.load('Images/title_edited.png')
